 ...
 *
 * The staggered entrance is pure CSS: .lum-enter with per-element
    ...
    return (
        ...
        >
            ...
            <img
                alt=""
                src={CO}
                className="lum-enter absolute bottom-full left-1/2 -translate-x-1/2 translate-y-[35%] h-44 w-auto pointer-events-none"
                style={{
            ...
            {/* No fixed max-width here — the welcome screen wraps this in
                the shared column box (.lum-column's container query), so
                the wrap width responds to the window like the composer's
                does. */}
            <div className="lum-enter flex flex-col items-center gap-1.5 [animation-delay:80ms]">
