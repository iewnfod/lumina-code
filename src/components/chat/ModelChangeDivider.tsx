 ...
 * flag (.lum-enter): a divider that appeared while the user watched
 * fades in, history bulk-mounted on open renders statically.
 */
export default function ModelChangeDivider({from, to, models, enter}: {
    ...
    return (
        <div className={`flex items-center gap-3 py-1 select-none${enter ? " lum-enter" : ""}`}>
